...
describe('API ENDPOINTS', () => {
  describe('POST', () => {
    it('should create a single meal', () => {
      chai
        .request(app)
        .post('/api/v1/meals')
        .send({
  ...
  it('should not create a single meal', (done) => {
    chai
      .request(app)
      .post('/api/v1/meals')
      .send({
  ...
  describe('GET', () => {
    ...
    it('should not get a single meal', (done) => {
      chai.request(app)
  ...
  describe('PUT', () => {
    it('should update a meal request and return 200 status code', (done) => {
      chai.request(app)
        .put('/api/v1/meal/1')
        .send({
            img: 'https://imagec.timeincapp.com/v3/mm/image?url=https%3A%2F%2Fcdn-image.myrecipes.com%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2Fgrilled-flank-steak-cherry-pecan-rice-ck.jpg%3Fitok%3DG3CZbicH&w=450&c=sc&poi=face&q=85',
